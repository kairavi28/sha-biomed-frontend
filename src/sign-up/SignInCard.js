...
export default function SignInCard() {
  ...
  const handleMicrosoftLogin = async () => {
    try {
      ...
      //store in db 
      const responseObj = await axios.post(`https://biomedwaste.net/api/user/microsoft-signin`, loginResponse.account, {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const response = await axios.post(`https://biomedwaste.net/api/user/login`, JSON.stringify(formData), {
        headers: {
